...
def make_change(amount)
  result = {}
  result[:H], amount = amount.divmod(50)
  result[:Q], amount = amount.divmod(25)
  result[:D], amount = amount.divmod(10)
  result[:N], amount = amount.divmod(5)
  result[:P], amount = amount.divmod(1)
  result.select { |_, v| v > 0 }
end
